...
public record BusinessOutcomeComparison(StrategyOutcome doNothing,StrategyOutcome blindRetry,StrategyOutcome recoverIQ,double improvementVsBlindRetry){
 ...
 public static BusinessOutcomeComparison from(BatchRecoveryEvaluator.Result r){return new BusinessOutcomeComparison(new StrategyOutcome(0,0),new StrategyOutcome(r.baselineRecoveredRevenue(),r.baselineRecoveryRate()),new StrategyOutcome(r.recoverIQRecoveredRevenue(),r.recoveryRate()),r.improvementPercentage());}
}
