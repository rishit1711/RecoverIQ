...
@RestController @RequestMapping("/api") public class RecoveryController {
 ...
 @PostMapping("/recovery/evaluate/batch") public Object batch(@RequestBody @jakarta.validation.Valid BatchRequest r){var result=service.batch(r.datasetSize,r.seed);return java.util.Map.of("evaluation",result,"businessOutcomeComparison",BusinessOutcomeComparison.from(result));}
